...
Version  : 1.2.0
Release  : 23
URL      : http://tarballs.openstack.org/python-ironicclient/python-ironicclient-1.2.0.tar.gz
Source0  : http://tarballs.openstack.org/python-ironicclient/python-ironicclient-1.2.0.tar.gz
...
%prep
%setup -q -n python-ironicclient-1.2.0
